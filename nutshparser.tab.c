...
{
      14,     0,    -1,     3,    12,    -1,     5,     8,     8,    12,
      -1,     6,    12,    -1,     7,     8,    12,    -1,     4,     8,
      12,    -1,     9,    12,    -1,     9,     8,     8,    12,    -1,
      10,     8,    12,    -1,    11,    12,    -1
};
...
{
  "$end", "error", "$undefined", "BYE", "CD", "SETENV", "PRINTENV",
  "UNSETENV", "STRING", "ALIAS", "UNALIAS", "CMD", "END", "$accept",
  "cmd_line", 0
};
#endif
...
{
      -3,    -7,     2,     3,     0,     6,     1,     7,     4,    17,
      -8,     8,    10,    -8,     9,    11,    -8,    12,    -8,    -8,
      -8,    13,    -8,    14,    -8,    -8,    -8
};
...
{
       1,     2,     3,     4,     5,    10,     6,     7,     8,    15,
      11,    12,    13,    16,    14,    17,    18,    19,    21,    23,
      20,    22,     0,     0,    24,    25,    26
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     6,     7,    12,     9,    10,    11,     8,
       8,     8,    12,    12,     8,     8,    12,     0,     8,     8,
      12,    12,    -1,    -1,    12,    12,    12
};
...
int runCMD() {
	...
	if (needsPipe == true)
	{
		...
		//if a pipe is determined to be needed, run cmd will just return without doing anything
		/*
